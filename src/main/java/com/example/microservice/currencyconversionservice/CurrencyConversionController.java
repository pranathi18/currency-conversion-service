...
public class CurrencyConversionController {
	...
	public CurrencyConversion calculateCurrencyConversion(
		...
		return new CurrencyConversion(currencyConversion.getId(), from, to, quantity, currencyConversion.getConversionMultiple(), 
				 quantity.multiply(currencyConversion.getConversionMultiple()), currencyConversion.getEnvironment()+" " + "Rest Api Template");	
	...
	public CurrencyConversion calculateCurrencyConversionFeign(
		...
		CurrencyConversion currencyConversion = proxy.retriveExchangedValue(from, to);
